...
const questions = [
    {
        question: 'Qual método é usado para adicionar um novo elemento ao final de um array em JavaScript?',
        answers: [
    ...
    {
        question: 'Em JavaScript, qual operador é usado para verificar igualdade estrita (valor e tipo)?',
        answers: [
            {text: '==', correct: false},
            {text: '&', correct: false},
            {text: '!==', correct: false},
    ...
    {
        question: 'Como se referencia o primeiro elemento de um array em JavaScript?',
        answers: [
    ...
    {
        question: 'Qual operador lógico é usado para verificar se pelo menos uma das condições é verdadeira?',
        answers: [
            {text: '||', correct: true},
            {text: '&&', correct: false},
            {text: '!', correct: false},
    ...
    {
        question: 'Qual método é usado para remover um elemento de um array em uma posição específica em JavaScript?',
        answers: [
            {text: 'cut()', correct: false},
    ...
    {
        question: 'Qual função é usada para obter o tipo de uma variável em JavaScript?',
        answers: [
...
function displayNextQuestion() { // essa função remove as respostas anteriores para poder adc as novas
...
function finishGame() {
    ...
    `<p class='final-message'>Você acertou ${totalCorrect} de ${totalQuestion} questões!</p>
